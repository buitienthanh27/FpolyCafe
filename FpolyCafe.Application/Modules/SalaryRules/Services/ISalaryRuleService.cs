...
public interface ISalaryRuleService
{
    ...
    Task<SalaryRuleDto> CreateSalaryRuleAsync(CreateSalaryRuleDto request, int actorUserId, string? ipAddress, CancellationToken cancellationToken = default);
    Task<SalaryRuleDto> UpdateSalaryRuleAsync(int id, UpdateSalaryRuleDto request, int actorUserId, string? ipAddress, CancellationToken cancellationToken = default);
}
