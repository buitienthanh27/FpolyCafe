...
public interface IBillService
{
    ...
    Task<int> CreateBillAsync(int? userId, int? customerId, CancellationToken cancellationToken = default);
    ...
    Task<bool> ApplyPromotionAsync(int billId, string promotionCode, CancellationToken cancellationToken = default);
...
public record BillDto(
    ...
    IEnumerable<BillDetailDto> Items
);
...
public record CreateBillRequestDto(int? UserId, int? CustomerId);
public record ApplyPromotionRequestDto(string Code);
